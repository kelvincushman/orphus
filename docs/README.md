...
| **[Live worker visibility](../README.md#live-worker-visibility)** | The `ORPHUS HARNESS · workers live` terminal panel for background subagents and workflow-owned workers. |

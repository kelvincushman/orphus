---
title: "Changelog"
description: "What's new in Orphus"
---
...
- **Packaged workflow discovery loads reliably.** Package-authored workflow resources load through `jiti`, so SDK imports such as `@orphus/workflows` resolve consistently from the Bun-packaged binary. See [Workflows](/workflows).

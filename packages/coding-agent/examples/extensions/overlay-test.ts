...
import type { ExtensionAPI, ExtensionCommandContext, Theme } from "@orphus/coding-agent";
...
class OverlayTestComponent implements Focusable {
	...
	private declare theme: Theme;
	private declare done: (result: { action: string; query?: string } | undefined) => void;

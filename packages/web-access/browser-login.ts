 ...
 * reaching the model. Three gates, enforced in order, each a distinct typed
 * refusal: the login feature flag, the vault's domain allowlist, and a
 * first-use human confirmation (`confirmedDomains`, populated only by
 * `/credential confirm <domain>`).
 *

 ...
 *
 * The script discovers installed harness skill directories in the project root
 * and creates/removes the pin in all of them.
 */
...
const HARNESS_DIRS = [
  '.claude', '.gemini', '.codex', '.agents', '.github', '.grok',

...
declare module "typebox" {
	export namespace Type {
		...
		>(value: TValue, options: TOptions): TLiteral<TValue> & TypeBoxDefaulted<TOptions>;

		export function Enum<
			const TValues extends TEnumValue[],
			const TOptions extends TypeBoxDefaultOptions<TSchemaOptions>,
		>(values: readonly [...TValues], options: TOptions): TEnum<TValues> & TypeBoxDefaulted<TOptions>;
		export function Enum<
		...
		export function Partial<
			...
			const TOptions extends TypeBoxDefaultOptions<TSchemaOptions>,
		>(type: TType, options: TOptions): TPartial<TType> & TypeBoxDefaulted<TOptions>;
		...
		export function Pick<
			...
			const TOptions extends TypeBoxDefaultOptions<TSchemaOptions>,
		>(type: TType, indexer: TIndexer, options: TOptions): TPick<TType, TIndexer> & TypeBoxDefaulted<TOptions>;
		...
		export function Omit<
			...
			const TIndexer extends TSchema,
			const TOptions extends TypeBoxDefaultOptions<TSchemaOptions>,
		>(type: TType, indexer: TIndexer, options: TOptions): TOmit<TType, TIndexer> & TypeBoxDefaulted<TOptions>;

		export function Required<
			const TType extends TSchema,
			const TOptions extends TypeBoxDefaultOptions<TSchemaOptions>,
		>(type: TType, options: TOptions): TRequired<TType> & TypeBoxDefaulted<TOptions>;

		export function Union<
			const TTypes extends TSchema[],
			const TOptions extends TypeBoxDefaultOptions<TSchemaOptions>,
		>(anyOf: [...TTypes], options: TOptions): TUnion<TTypes> & TypeBoxDefaulted<TOptions>;

		export function Intersect<
			const TTypes extends TSchema[],
			const TOptions extends TypeBoxDefaultOptions<TIntersectOptions>,
		>(types: [...TTypes], options: TOptions): TIntersect<TTypes> & TypeBoxDefaulted<TOptions>;

		export function Record<
			const TKey extends TSchema,
			const TValue extends TSchema,
			const TOptions extends TypeBoxDefaultOptions<TObjectOptions>,
		>(key: TKey, value: TValue, options: TOptions): TypeBoxRecord<TKey, TValue> & TypeBoxDefaulted<TOptions>;

		export function Tuple<
			const TTypes extends TSchema[],
			const TOptions extends TypeBoxDefaultOptions<TTupleOptions>,
		>(types: [...TTypes], options: TOptions): TTuple<TTypes> & TypeBoxDefaulted<TOptions>;

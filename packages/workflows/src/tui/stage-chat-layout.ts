...
export function resolveStageChatViewportRows(reported: number | undefined, fallbackRows: number): number {
...
export function fitStageChatFrame(lines: string[], viewportRows: number, blankLine: string): string[] {

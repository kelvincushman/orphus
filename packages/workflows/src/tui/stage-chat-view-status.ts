...
export function isTerminalOrNonStreamingStageChatStatus(status: string | undefined): boolean {
...
export function isTerminalStageChatTransition(
	...
	return (
		!isTerminalOrNonStreamingStageChatStatus(previousStatus) && isTerminalOrNonStreamingStageChatStatus(currentStatus)
	);
}

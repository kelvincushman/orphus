...
test("restoreOnSessionStart restores terminal run end time and duration", () => {
	...
	const entries: SessionEntry[] = [
		...
		},
		{
			...
			payload: { runId: "r1", stageId: "s1", status: "completed", summary: "done" },
		},
		{
			id: "e4",
			type: "workflow.run.end",
			payload: { runId: "r1", status: "completed", endedAt: 5000, durationMs: 4999, ts: 5000 },
		},
	];
	...
	const entries: SessionEntry[] = [
		{
			...
			data: { runId: "r-custom-live", name: "wf", inputs: {}, ts: 10 },
		},
		{
			id: "c2",
			type: "custom",
			customType: "workflow.stage.start",
			data: { runId: "r-custom-live", stageId: "s1", name: "review", parentIds: [], ts: 11 },
		},
	];
	...
	const entries: SessionEntry[] = [
		{
			...
			type: "custom",
			customType: "workflow.run.start",
			data: { runId: "r-custom-terminal", name: "wf", inputs: {}, ts: 10 },
		},
		{
			id: "c2",
			type: "custom",
			customType: "workflow.stage.start",
			data: { runId: "r-custom-terminal", stageId: "s1", name: "review", parentIds: [], ts: 11 },
		},
		{
			id: "c3",
			type: "custom",
			customType: "workflow.stage.end",
			data: { runId: "r-custom-terminal", stageId: "s1", status: "completed", summary: "done", durationMs: 5 },
		},
		{
			id: "c4",
			type: "custom",
